...
/** Validate the Serial Port Information.
  ...
  @param [in]  SerialPortInfoTable    Table of CM_RISCV_SERIAL_PORT_INFO.
...
ValidateSerialPortInfo (
  IN  CONST CM_RISCV_SERIAL_PORT_INFO  *SerialPortInfoTable,
  IN        UINT32                   SerialPortCount
  )
{
  UINT32                         Index;
  CONST CM_RISCV_SERIAL_PORT_INFO  *SerialPortInfo;
...
FixupIds (
  ...
  IN  CONST UINT64                   Uid,
  IN  CONST CM_RISCV_SERIAL_PORT_INFO  *SerialPortInfo
  )
{
  EFI_STATUS              Status;
