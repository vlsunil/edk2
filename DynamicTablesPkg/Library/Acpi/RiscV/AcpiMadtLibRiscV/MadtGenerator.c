...
Requirements:
  ...
  this Generator:
  - EArchObjRintcInfo
  - EArchObjImsicInfo (OPTIONAL)
  - EArchObjAplicInfo (OPTIONAL)
  - EArchObjPlicInfo  (OPTIONAL)
*/
...
AddRINTC (
  ...
  IN  CONST CM_ARCH_RINTC_INFO     *CONST   RintcInfo,
  ...
  )
{
  ...
  Uid1 = ((CM_ARCH_RINTC_INFO *)RintcInfo1)->AcpiProcessorUid;
  Uid2 = ((CM_ARCH_RINTC_INFO *)RintcInfo2)->AcpiProcessorUid;
...
AddRINTCList (
  ...
  IN  CONST CM_ARCH_RINTC_INFO      *RintcInfo,
...
AddIMSIC (
  ...
  CONST CM_ARCH_IMSIC_INFO     *CONST   ImsicInfo
  )
{
  ASSERT (Imsic != NULL);
...
AddAPLIC (
  ...
  IN  CONST CM_ARCH_APLIC_INFO  *CONST       AplicInfo
  )
{
  UINTN  i;
...
AddAPLICList (
  ...
  IN  CONST CM_ARCH_APLIC_INFO      *AplicInfo,
...
AddPLIC (
  ...
  IN  CONST CM_ARCH_PLIC_INFO  *CONST       PlicInfo
  )
{
  UINTN  i;
...
AddPLICList (
  ...
  IN  CONST CM_ARCH_PLIC_INFO      *PlicInfo,
  IN  UINT32                       PlicCount
  )
{
  ASSERT (Plic != NULL);
  ...
  )
{
  ...
  CM_ARCH_APLIC_INFO  *AplicInfo;
  CM_ARCH_PLIC_INFO   *PlicInfo;
  UINT32              RintcOffset;
  UINT32              ImsicOffset;
  UINT32              AplicOffset;
  UINT32              PlicOffset;
  ...
  *Table = NULL;
  ...
  if (RintcCount == 0) {
    DEBUG ((
      DEBUG_ERROR,
      "ERROR: MADT: RINTCinformation not provided.\n"
      ));
    ASSERT (RintcCount != 0);
