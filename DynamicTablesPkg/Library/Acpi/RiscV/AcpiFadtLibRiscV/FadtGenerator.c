...
/** RISCV standard FADT Generator

Requirements:
  The following Configuration Manager Object(s) are required by
  this Generator:
  - ERiscVObjPowerManagementProfileInfo
  - ERiscVObjBootArchInfo
  - ERiscVObjHypervisorVendorIdentity (OPTIONAL)
*/

/** This macro defines the FADT flag options for RISCV Platforms.
*/
...
GET_OBJECT_LIST (
  EObjNameSpaceRiscV,
  ERiscVObjHypervisorVendorIdentity,
...
{
  EFI_STATUS                            Status;
  CM_RISCV_POWER_MANAGEMENT_PROFILE_INFO  *PmProfile;

  ASSERT (CfgMgrProtocol != NULL);

  // Get the Power Management Profile from the Platform Configuration Manager
  Status = GetERiscVObjPowerManagementProfileInfo (
             CfgMgrProtocol,
             CM_NULL_TOKEN,
             &PmProfile,
             NULL
...
{
  EFI_STATUS                   Status;
  CM_RISCV_HYPERVISOR_VENDOR_ID  *HypervisorVendorInfo;

  ASSERT (CfgMgrProtocol != NULL);

  // Get the Hypervisor Vendor ID from the Platform Configuration Manager
  Status = GetERiscVObjHypervisorVendorIdentity (
             CfgMgrProtocol,
             CM_NULL_TOKEN,
  ...
  DEBUG ((
    DEBUG_INFO,
    "FADT: ERiscVObjHypervisorVendorIdentity = 0x%lx\n",
...
{
  EFI_STATUS                  Status;
  CM_RISCV_FIXED_FEATURE_FLAGS  *FixedFeatureFlags;

  ASSERT (CfgMgrProtocol != NULL);

  // Get the Fixed feature flags from the Platform Configuration Manager
  Status = GetERiscVObjFixedFeatureFlags (
             CfgMgrProtocol,
             CM_NULL_TOKEN,
             &FixedFeatureFlags,
             NULL
  ...
  DEBUG ((
    DEBUG_INFO,
    "FADT: ERiscVObjFixedFeatureFlags = 0x%x\n",
