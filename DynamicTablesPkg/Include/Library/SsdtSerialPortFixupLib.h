...
BuildSsdtSerialPortTable (
  ...
  IN  CONST CM_STD_SERIAL_PORT_INFO      *SerialPortInfo,
  IN  CONST CHAR8                        *Name,
  IN  CONST UINT64                       Uid,
...
/** Validate the Serial Port Information.
  ...
  @param [in]  SerialPortInfoTable    Table of CM_STD_SERIAL_PORT_INFO.
...
ValidateSerialPortInfo (
  IN  CONST CM_STD_SERIAL_PORT_INFO  *SerialPortInfoTable,
