...
/** Parse a "cpu" node.
  ...
  @param [in]  AddressCells     Number of address cells used for the reg
                                property.
  @param [out] RintcInfo         CM_ARCH_RINTC_INFO structure to populate.
