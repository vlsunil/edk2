...
/** STD standard SPCR Table Generator
...
EFI_ACPI_SERIAL_PORT_CONSOLE_REDIRECTION_TABLE  AcpiSpcr = {
  ...
  STD_GAS32 (0), // {Template}: Serial Port Base Address
  0,
  0, // Not used on ARM
...
{
  EFI_STATUS                   Status;
  CM_STD_SERIAL_PORT_INFO      *SerialPortInfo;
  ...
  *Table = NULL;
  ...
  Status = GetEStdObjSerialConsolePortInfo (
             CfgMgrProtocol,
             CM_NULL_TOKEN,
             &SerialPortInfo,
             &SerialPortCount
