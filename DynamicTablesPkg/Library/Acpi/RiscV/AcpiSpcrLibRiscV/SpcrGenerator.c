...
#include <Library/RiscVSsdtSerialPortFixupLib.h>
#include <Library/TableHelperLib.h>
#include <Protocol/ConfigurationManagerProtocol.h>

/** RISCV standard SPCR Table Generator
...
{
  EFI_STATUS                   Status;
  CM_RISCV_SERIAL_PORT_INFO      *SerialPortInfo;
  ...
  *Table = NULL;
  ...
  Status = GetERiscVObjSerialConsolePortInfo (
             CfgMgrProtocol,
             CM_NULL_TOKEN,
             &SerialPortInfo,
             &SerialPortCount
